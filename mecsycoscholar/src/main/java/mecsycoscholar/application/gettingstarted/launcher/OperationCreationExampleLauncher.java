...
/**
 * Interacting models with an event operation.
 *
 */
public abstract class OperationCreationExampleLauncher {
	...
	public static void main(String[] args) {
		...
		final double newSize = 8.;
		EventOperation sizeSetter = new TurtleSizeSetter(newSize);
