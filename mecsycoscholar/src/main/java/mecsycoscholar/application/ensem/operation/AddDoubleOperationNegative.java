 ...
 * of double).
 */
public class AddDoubleOperationNegative extends EventOperation {
	 ...
	 * @param operand
	 */
	public AddDoubleOperationNegative(double operand) {
	 ...
	 * @param aParameterMap
	 */
	public AddDoubleOperationNegative(Map<String, Object> aParameterMap) {
		// Get one element of the parameters map (normally, there is only one).
	...
	public SimulData apply(SimulEvent aEvent) {
		return new Tuple1<Double>((((Double) ((Tuple1<?>) aEvent.getData()).getItem1()) + arg) * -1);
	}
