 ...
 *
 */
public class ControllerJavaDslModelArtifact extends ModelArtifact {
	...
	public ControllerJavaDslModelArtifact(String aModelId, ControllerJava controller) {
		super(aModelId);
	 ...
	 */
	public ControllerJavaDslModelArtifact(String aModelId,
		...
		this.controller = new ControllerJava(inputPortNames, outputPortNames, period, minTemp, maxTemp, temp, powMax,
				pow);
	}
