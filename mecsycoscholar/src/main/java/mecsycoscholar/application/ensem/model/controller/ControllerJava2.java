...
public class ControllerJava2 {
	...
	public ControllerJava2(String[] inputPortNames, String[] outputPortNames, double period,
	...
	public void computeOrders(double time) {
		...
		// example
		double mod_hour = (time/3600) % 24;
		if(mod_hour<=12 || mod_hour>=20) {
