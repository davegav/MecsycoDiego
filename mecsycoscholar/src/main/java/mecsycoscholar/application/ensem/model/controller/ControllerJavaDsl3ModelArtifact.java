 ...
 *
 */
public class ControllerJavaDsl3ModelArtifact extends ModelArtifact {
	 ...
	 * Controller model
	 */
	private ControllerJava3 controller;

	public ControllerJavaDsl3ModelArtifact(String aModelId, ControllerJava3 controller) {
		super(aModelId);
	 ...
	 */
	public ControllerJavaDsl3ModelArtifact(String aModelId,
			Map<String, Object> parameters) {
		super(aModelId);
		// We set the name of the inputs, outputs and parameters
		String[] inputPortNames = new String[] {"Temp1", "Temp2", "Temp3", "Occup"};
		String[] outputPortNames = new String[] {"Pow1_out", "Pow2_out", "Pow3_out"};
		double period = ((Number) parameters.get("step")).doubleValue();
		double minTemp = ((Number) parameters.get("minTemp")).doubleValue();
		double maxTemp = ((Number) parameters.get("maxTemp")).doubleValue();
		...
		this.controller = new ControllerJava3(inputPortNames, outputPortNames, period, minTemp, maxTemp, temp, powMax,
				pow);
	}
