...
to setup
  ...
  clear-plot
  set X prey-population
  set Y predator-population
end

to go
  set D_X ( prey-growth * X - prey-loss * X * Y  )
  set D_Y ( predator-growth * Y * X - predator-loss * Y )
  set X ( X + 0.01 * D_X )
  set Y ( Y + 0.01 * D_Y )
  do-plotting
  tick
...
to do-plotting
  ...
  set-current-plot-pen "prey-predator"
  plotxy  X Y
end
...
"" ""
PENS
"prey-predator" 1.0 0 -16777216 true "" ""
