...
to setup
  reset-ticks
  set-current-plot "Evolution of the intensity of the convection motion"
  clear-plot
  set X X0
  set Y Y0
end
...
to go
  set D_X ( a * ( Y - X ) )
  set X ( X + D_X * time-discretization )
  do-plotting
  tick
end
...
to do-plotting
  ...
  plot  X
  set-current-plot "Phase space X Y axis"
